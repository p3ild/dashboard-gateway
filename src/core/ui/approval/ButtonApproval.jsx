...
export const ButtonApproval = ({
    ...
    useEffect(() => {
        logger.info('supportApproval', supportApproval)
    }, [supportApproval])
        ...
        if (approvalType == APPROVAL_TYPE.ACCEPT) {
            switch (true) {
                ...
                case ["UNAPPROVED_READY"].includes(state):
                    let message = "Cấp dưới chưa duyệt";
                    isApproved = false
            ...
            switch (true) {
                ...
                case (["UNAPPROVED_WAITING"].includes(state)): {
                    errors.push({
                        label: "Cấp dưới chưa duyệt",
                        description: "Yêu cầu cấp dưới phê duyệt trước khi duyệt cấp trên.",
                ...
                case (["APPROVED_ABOVE"].includes(state)): {
                    errors.push({
                        label: "Cấp trên đã duyệt",
                        description: "Nếu cần sửa số liệu, liên hệ cấp trên để bỏ duyệt.",
