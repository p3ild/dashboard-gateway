...
export function HeaderUILayoutTable1({ listColumnConfig }) {
    ...
    return <thead>
        ...
        <tr>
            ...
            <th {...excelConfig}>TYT đạt tiêu chí QG về YT</th>
            <th {...excelConfig}>TYT triển khai dự phòng, quản lý điều trị bệnh không lây nhiễm</th>
            <th {...excelConfig}>Xã/phường có TYT</th>
            <th {...excelConfig}>TYT có bác sỹ định biên</th>
            <th {...excelConfig}>TYT có bác sỹ làm việc</th>
            <th {...excelConfig}>TYT có tổ y học cổ truyền</th>
            <th {...excelConfig}>TYT có hộ sinh/y sĩ sản nhi</th>
