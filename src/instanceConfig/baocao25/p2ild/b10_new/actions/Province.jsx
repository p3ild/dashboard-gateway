    ...
    let reqPublicHealthGroup = [
        {
            ...
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TW_CSYT_CONG_SR_PHONG_HIV_TT] }),
        ...
        },
        {
            ...
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TINH_CSYT_CONG_SR_PHONG_HIV_TT] }),
    ...
    let reqPrivateHealthGroup = [
        {
            ...
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TINH_YTTN_BENH_VIEN_SR_PHONG_HIV_TT, ORG_GROUP.TINH_YTTN_PHONG_KHAM_SR_PHONG_HIV_TT] }),
