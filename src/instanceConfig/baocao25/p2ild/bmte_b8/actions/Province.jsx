...
export const getDataCommon = async (props) => {
    ...
    let reqPublicHealthGroup = [
        {
            orgUnitGroupQueryTarget: [ORG_GROUP.TW_CSYT_CSSK_TE],
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TW_CSYT_CSSK_TE] }),
        ...
        },
        {
            ...
            // ],
            orgUnitGroupQueryTarget: [ORG_GROUP.TINH_CSYT_CONG_CSSK_TE],
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TINH_CSYT_CONG_CSSK_TE] }),
    ...
    let reqPrivateHealthGroup = [
        {
            ...
            // ],
            orgUnitGroupQueryTarget: [ORG_GROUP.TINH_YTTN_CSSK_TE],
            orgUnit: getOrgParentIDByChildOuGroup({ orgFullArray, orgUnit: props.orgUnit, ouAggregateLevel: 3, ouChildGroup: [ORG_GROUP.TINH_YTTN_CSSK_TE] }),
        ...
        [
            ...reqPublicHealthGroup.map((reqProps, idx) => {
                return cb => listingRowByOuGroup({
                    ...
                    let isIncludeXa = (reqPublicHealthGroup[idx].orgUnitGroup || reqPublicHealthGroup[idx].orgUnitGroupQueryTarget || []).some(x => x == ORG_GROUP.XA_DVHC)
                    let colDisable = []
