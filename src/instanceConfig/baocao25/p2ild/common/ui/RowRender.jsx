...
export const listingRowByOuGroup = async (props) => {
    ...
    listOrgApproval &&  approvalConfig && props.approvalUtils.addGroupApproval({
...
export const getDataEachRow = (data) => {
    let rowData = data?.listColumnConfig?.map((e, colIndex) => {
